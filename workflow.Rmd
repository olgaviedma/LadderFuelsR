...
```{r Crowns Silva metrics, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r CBH and the LAD percentage below and above the CBH using the breaking point method. Threshold for calculating CBH and derived metrics is to have LAD percentage greater than 75, echo=TRUE, message=FALSE, warning=FALSE}
